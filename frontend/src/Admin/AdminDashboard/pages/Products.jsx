                    ...
                    <div className="col-lg-2 mt-2">
                        <div className="card" >
                            <div className="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                <Link to={"/Product"}>
                                    <img src="https://rukminim1.flixcart.com/image/416/416/xif0q/computer/u/k/w/-original-imaggqgcggpau2zr.jpeg?q=70" className="img-fluid" alt='' style={{ height: "210px", width: "0px" }} />
                                </Link>
                                {/* <a href="/Item">
